...
{
    protected const BASE_AUTH_URI = 'https://ngw.devices.sberbank.ru:9443';

    protected const AUTH_URI = 'api/v2/oauth';

    protected const TOKEN_CACHE_KEY = 'gigachat:access_token';
    ...
    {
        $token = $this->cache->get(static::TOKEN_CACHE_KEY);
        if ($token !== null) {
            return $token;
        }
        ...
        $this->cache->set(static::TOKEN_CACHE_KEY, $token, $ttl);
    ...
    {
        return $this->getAuthClient()->postAsync(static::AUTH_URI, [
